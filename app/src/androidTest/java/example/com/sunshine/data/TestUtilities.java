...
import static example.com.sunshine.data.contract.WeatherContract.WeatherEntry.COLUMN_DATE;
import static example.com.sunshine.data.contract.WeatherContract.WeatherEntry.COLUMN_DEGREES;
import static example.com.sunshine.data.contract.WeatherContract.WeatherEntry.COLUMN_HUMIDITY;
import static example.com.sunshine.data.contract.WeatherContract.WeatherEntry.COLUMN_MAX_TEMP;
import static example.com.sunshine.data.contract.WeatherContract.WeatherEntry.COLUMN_MIN_TEMP;
import static example.com.sunshine.data.contract.WeatherContract.WeatherEntry.COLUMN_PRESSURE;
import static example.com.sunshine.data.contract.WeatherContract.WeatherEntry.COLUMN_WEATHER_ID;
import static example.com.sunshine.data.contract.WeatherContract.WeatherEntry.COLUMN_WIND_SPEED;
...
class TestUtilities {
    ...
    static void validateThenCloseCursor(String error, Cursor valueCursor, ContentValues expectedValues) {
        assertNotNull("This cursor is null. Did you make sure to register your ContentProvider in the manifest?", valueCursor);
